...
CREATE TABLE `ordencompra` (
  ...
  KEY `ordCliente` (`ordCliente`),
  KEY `ordProducto` (`ordProducto`),
  KEY `ordServicio` (`ordServicio`),
  KEY `idCliente` (`idCliente`),
  KEY `idDetallesCompra` (`idDetallesCompra`),
  KEY `idEnvio` (`idEnvio`),
  CONSTRAINT `ordencompra_ibfk_1` FOREIGN KEY (`ordCliente`) REFERENCES `cliente` (`idCliente`),
  ...
  CONSTRAINT `ordencompra_ibfk_4` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idCliente`),
