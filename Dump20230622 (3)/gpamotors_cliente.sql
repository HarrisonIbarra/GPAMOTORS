...
CREATE TABLE `cliente` (
  ...
  `cliCiudad` int NOT NULL,
  `cliTipoDocumento` varchar(50) NOT NULL,
  `cliDocumento` varchar(50) NOT NULL,
  `cliGenero` char(1) NOT NULL,
  `cliContraseña` varchar(50) NOT NULL,
  PRIMARY KEY (`idCliente`),
  KEY `cliCiudad` (`cliCiudad`),
  CONSTRAINT `cliente_ibfk_1` FOREIGN KEY (`cliCiudad`) REFERENCES `ciudad` (`idCiudad`)
